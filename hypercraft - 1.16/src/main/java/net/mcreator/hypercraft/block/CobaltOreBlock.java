...
public class CobaltOreBlock extends HypercraftModElements.ModElement {
	@ObjectHolder("hypercraft:cobaltore")
	public static final Block block = null;
	public CobaltOreBlock(HypercraftModElements instance) {
		super(instance, 3);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("hypercraft:cobaltore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hypercraft:cobaltore"), configuredFeature);
		}
	}
	@SubscribeEvent

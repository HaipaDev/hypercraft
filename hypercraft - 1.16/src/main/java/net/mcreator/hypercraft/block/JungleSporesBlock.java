...
import net.mcreator.hypercraft.procedures.JungleSporesPoisonProcedure;
...
public class JungleSporesBlock extends HypercraftModElements.ModElement {
	@ObjectHolder("hypercraft:junglespores")
	public static final Block block = null;
	public JungleSporesBlock(HypercraftModElements instance) {
		super(instance, 1);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("junglespores"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("hypercraft:junglespores"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				JungleSporesPoisonProcedure.executeProcedure($_dependencies);
			}
		}
